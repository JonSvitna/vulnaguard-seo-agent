          ...
          <div>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, tableLayout: "fixed" }}>
                <colgroup>
                  <col style={{ minWidth: 160 }} />{/* Company */}
                  <col style={{ minWidth: 100 }} />{/* Status */}
                  <col style={{ minWidth: 140 }} />{/* Category */}
                  <col style={{ minWidth: 60 }} /> {/* Score */}
                  <col style={{ minWidth: 90 }} /> {/* CMMC Level */}
                  <col style={{ minWidth: 110 }} />{/* Location */}
                  <col style={{ minWidth: 160 }} />{/* Email */}
                  <col style={{ minWidth: 100 }} />{/* Persona */}
                  <col style={{ minWidth: 270 }} />{/* Actions */}
                </colgroup>
                <thead>
                  <tr>
                    {["Company", "Status", "Category", "Score", "CMMC Level", "Location", "Email", "Persona", "Actions"].map(h => (
                      <th key={h} style={{ textAlign: "left", padding: "8px 12px", color: "#555", fontWeight: 600, borderBottom: "1px solid rgba(255,255,255,0.08)", fontSize: 10, letterSpacing: "0.05em", textTransform: "uppercase", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
