...
// and `0005_add_invalid_email_status.sql`.
// When a future phase introduces a new real state, add it here *and* widen
// the CHECK constraint in that phase's own migration — don't pre-add
// speculative states.
//
...
export const LEAD_STATUSES = [
  'discovered', 'no_email', 'invalid_email', 'qualified', 'disqualified', 'rejected',
